            ...
            ?>
                <div class="col-lg-11 col-xl-9">
                    <div class="card" style="border-radius: 10px;">
                        ...
                        <div class="card-footer border-0 px-4 py-5" style="background-color: #FA5882; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                            <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">
                                Tổng Tiền: <span class="h2 mb-0 ms-2">$ <?php $formattedPrice = number_format($totalall, 2, '.', ','); echo $formattedPrice; ?></h5>
                        </div>
                    </div>
                </div>
