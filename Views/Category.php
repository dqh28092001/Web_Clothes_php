                    ...
                    <div class="shop__sidebar">
                        ...
                        <div class="sidebar__sizes">
                            ...
                            <div class="size__list">
                                <label for="xxs">
                                <a class="form-check-label price-range-link" href="../Views/category.php?idcategory=<?php echo $idcategory; ?>&price-range=100-500">
                        100$ - 500$
                    </a>
                                    
                                </label>
                                <label for="xs">
                                <a class="form-check-label price-range-link" href="../Views/category.php?idcategory=<?php echo $idcategory; ?>&price-range=1000-5000">
                        1000$ - 5000$
                    </a>
                                    
                                </label>
                                <label for="xss">
                                <a class="form-check-label price-range-link" href="../Views/category.php?idcategory=<?php echo $idcategory; ?>&price-range=5000">
                        Trên 5000$
                    </a>
                                </label>
                                ...
                                <div class="card rounded-0">
                                    ...
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                        <ul class="list-unstyled">
                                            <li><a class="btn btn-success text-white mt-2" href="../Views/DetailProduct.php?id=<?php echo $id; ?>"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card-body">
