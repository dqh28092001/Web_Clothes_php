  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
      <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;background: #fff;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td bgcolor="#ffffff" align="left" style="background: pink;padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
              <p style="margin: 0;">Cảm ơn bạn đã chọn Ashion, vui lòng kiểm tra email và nhập mã xác
                thực để đăng ký tài khoản thành công.</p>
            </td>
          </tr>
          <form id="formvertifi">
            <tr>
              <td bgcolor="#ffffff" align="left">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;background: pink;">
                      <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td>
                            <button type="submit" id="vertifi" class="mt-3 btn btn-success">Xác Thực</button </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td bgcolor="#FFC9DD" align="center" style="padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
              <p><a href="../views/Home.php" class="link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Trang
                  Chủ</a></p>
            </td>
          </tr>
        </table>
...
<script>
  $(document).ready(function() {
    $("#formvertifi").submit(function(event) {
      ...
      $.ajax({
        type: 'POST',
        url: '../../Authentication/LoginAndRegister/vertifi.php',
        data: {
          username: username,
