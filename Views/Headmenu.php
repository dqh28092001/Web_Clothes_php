...
<head>
    ...
    <!-- <link rel="stylesheet" href="../Public/css/bootstrap431.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous"> -->
...
<nav class="navbar navbar-expand-lg navbar-light shadow">
    <div class="container d-flex justify-content-between align-items-center">
        <a class="navbar-brand text-success logo h2 align-self-center" href="../views/Home.php?page=1">
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between"
            ...
            <div class="flex-fill">
                <ul class="navbar-nav d-flex justify-content-between mx-lg-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../views/Home.php?page=1">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="categoriesDropdown">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $id = $row['id'];
                                ?>
                               <a class="dropdown-item idcategory" href="../Views/Category.php?idcategory=<?php echo $id; ?>"><?php echo $name; ?></a>
                                <?php
                            }
                            ?>
                        </div>
            ...
            <div class="navbar align-self-center d-flex">
                ...
                ?>
                <a class="nav-icon position-relative text-decoration-none" href="../Views/Cart.php">
                ...
                <?php } else { ?>
                <a class="nav-icon position-relative text-decoration-none" href="../Views/LoginAndRegister/LoginAndRegister.php">
                    <i class="fa fa-fw fa-cart-arrow-down mr-1"></i>
                </a>
                <?php } ?>
                <div class="dropdown">
                    ...
                    <a class="nav-link" href="#" role="button" id="userDropdown" data-toggle="dropdown" aria-expanded="false">
                        <div class="avatar">
                            <img src="../Public/img/<?php echo $image;?>" alt="User Avatar"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="userDropdown">
                        ...
                        <?php if ($permission == 1) { ?>
                            <li><a class="dropdown-item" href="../Views/Admin/Admincategory.php">Trang Admin</a></li>
                        <?php } ?>
                        <li><a class="dropdown-item" href="../views/Editprofile.php">Chỉnh Sửa Tài Khoản</a></li>
                        <li><a class="dropdown-item" href="../Views/UserListOder.php">Quản Lí Đơn Hàng</a></li>
                        <li><a class="dropdown-item" href="../Authentication/LoginAndRegister/logout.php">Đăng xuất</a></li>
                       
                    </ul>
                    <?php } else { ?>
                        <a class="dropdown-item" href="../Views/LoginAndRegister/LoginAndRegister.php">Đăng Nhập</a>
                    <?php } ?>
                </div>
            </div>
        </div>
