    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr>
        <td bgcolor="" align="center" style="background: #fff;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td align="center" valign="top" style="padding: 115px 10px 40px 10px;"></td>
            </tr>
          </table>
        </td>
      </tr>
      ...
      <tr>
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;background: #fff;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td bgcolor="#ffffff" align="left" style="    background-color: pink;padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                <p style="margin: 0;    color: #dc3545;
    font-family: emoji;
    font-weight: 500;">Chúng tôi đã gửi mã xác minh tới Emaill của bạn, Vui lòng vào Emaill để kiểm tra! 
              </td>
            </tr>
            <tr>
            <!-- <tr>
      ...
      <tr>
        <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 16pc 10px;background: #fff;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td bgcolor="#FFC9DD" align="center" style="padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                <p><a href="../Home.php" class="link link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" style="text-decoration: none;font-size: 25px;
