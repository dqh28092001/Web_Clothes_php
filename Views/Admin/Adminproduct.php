...
<div id="content" style="margin-left: 270px;
    ...
    border: none;"><a href="" style="color: #fff;">Tổng</a></label>
        ...
        <!-- <div class="col-2 mt-3">
            <input type="range" class="form-range" min="0" max="6000" step="100" id="slider">
            <div class="mt-2">
                Từ 0 đến <span id="sliderValue"> 3000</span> $
            </div>
        </div> -->
...
<script>
  function view_data(selectedValue,searchValue,slidervalue,categoryId){
      $.post('../../Authentication/Admin/adminlistproduct.php',{ selectedValue: selectedValue, searchValue: searchValue, slidervalue:slidervalue,categoryId}, function(data) {
  ...
  $(document).ready(function() {
    ...
    slider.addEventListener('input', function() {
        ...
        sliderValue.innerText = slidervalue;
        var selectedValue = $("input[name='btnradio1']:checked").data("id");
        var searchValue = $("#search-input").val();
        view_data(selectedValue, searchValue,slidervalue);
    });
