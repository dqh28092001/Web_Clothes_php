...
<body>
    <h2>WELCOME TO LUCASBIT SHOP</h2>
    <!-- Đăng Kí -->
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form id="signinForm">
                ...
                <a href="../view/Forgot_Password.php">Forgot your password?</a>
...
<script>
    ...
    $(document).ready(function () {
        $("#username").blur(function () {
            ...
            $.get("../Functions/Register.php", { username: username }, function (data) {
        ...
        $("#email").blur(function () {
            var email = $(this).val();
            $.get("../Functions/Register.php", { email: email }, function (data) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.message == 'xacthuc') {
                        ...
                        window.location.href = '../view/Admincategory.php';
                    } else
