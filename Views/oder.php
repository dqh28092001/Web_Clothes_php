...
<div class="container" style="min-height:800px;">
    ...
    <div class="row mt-2">
        <div><h2><b>Chi Tiết Đơn Hàng</b></h2></div>
    </div>
    <div class="row">
        <div class="d-flex align-items-center"> 
            ...
            <button type="button" id="btnthaydoi" class="btn btn-success ml-3" data-toggle="modal" data-target="#exampleModal">Thay Đổi</button>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="border-top mt-3">
                        ...
                        <button type="button" class="btn btn-success addNewAddressBtn">Thêm Mới</button>
                    </div>
                </div>
...
?>
    <script>
    function view_data() {
        $.post('../Authentication/listthanhtoan.php', { username: '<?php echo $username; ?>' }, function(data) {
            $("#listcart").html(data);
        });
    }
