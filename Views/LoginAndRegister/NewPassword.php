...
<html>
  ...
  <body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <!-- LOGO -->
      <tr>
        <td bgcolor="pink" align="center" style="background: #fff;"">
      ...
      <tr>
        <td bgcolor="pink" align="center" style="padding: 0px 10px 0px 10px;background: #fff;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
      ...
      <tr>
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;background: #fff;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
            <!-- <tr>
              <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 40px 30px ;background: pink; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
      ...
      <tr>
        <td bgcolor="#f4f4f4" align="center" style=" background: pink;padding: 30px 10px 0px 10px;background: #fff;"">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td bgcolor="#FFC9DD" align="center" style=" background: pink;padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; color: #666666;font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                <p><a href="../views/Home.php" class="link link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" style="text-decoration: none;font-size: 25px;
    font-weight: 900;color:black">Trang Chủ</a></p>
              </td>
            </tr>
          </table>
        </td>
...
$(document).ready(function() {    
    ...
    $("#formnewpass").submit(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../Authentication/LoginAndRegister/ForgotPasswordNew.php',
